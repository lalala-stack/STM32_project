...
void lcd_draw_vline(uint16_t x, uint16_t y, uint16_t len, uint16_t color);					/* 画垂直线 */
...
void lcd_show_double(uint16_t x, uint16_t y, double num, uint8_t int_len, uint8_t dec_len, uint8_t size, uint16_t color);	/* 显示双精度浮点数 */
