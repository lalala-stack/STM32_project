...
#define _USE_HARDWARE_SPI_ 0 //�?否使用硬件SPI
...
#define CSR_ADD   0x00 // CSR  Channel Select Register(通道选择寄存�?)                1 Bytes
#define FR1_ADD   0x01 // FR1  Function Register 1(功能寄存�?1)                       3 Bytes
#define FR2_ADD   0x02 // FR2  Function Register 2(功能寄存�?2)                       2 Bytes
#define CFR_ADD   0x03 // CFR  Channel Function Register(通道功能寄存�?)              3 Bytes
#define CFTW0_ADD 0x04 // CFTW0 Channel Frequency Tuning Word 0(通道频率�?换字寄存�?)  4 Bytes
#define CPOW0_ADD 0x05 // CPW0 Channel Phase Offset Word 0(通道相位�?换字寄存�?)      2 Bytes
#define ACR_ADD   0x06 // ACR  Amplitude Control Register(幅度控制寄存�?)             3 Bytes
